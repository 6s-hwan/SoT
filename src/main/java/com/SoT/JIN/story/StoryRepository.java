...
public interface StoryRepository extends JpaRepository<Story, Long> {
    ...
    List<Story> findAllByOrderByViewCountDesc();
    List<Story> findAllByOrderByUploadTimeDesc();

    List<Story> findByTheme(String theme);
    List<Story> findByThemeOrderByLikesDesc(String theme);
    List<Story> findByThemeOrderByViewCountDesc(String theme);
    List<Story> findByThemeOrderByUploadTimeDesc(String theme);
}